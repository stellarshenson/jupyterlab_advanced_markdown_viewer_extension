...
# Change directory to the jupyterlab_advanced_markdown_viewer_extension directory
...
jupyter server extension enable jupyterlab_advanced_markdown_viewer_extension
...
jupyter server extension disable jupyterlab_advanced_markdown_viewer_extension
...
folder is located. Then you can remove the symlink named `jupyterlab_advanced_markdown_viewer_extension` within that folder.
...
```sh
pytest -vv -r ap --cov jupyterlab_advanced_markdown_viewer_extension
```
